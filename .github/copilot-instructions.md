# GitHub Copilot Instructions — CLA Spec Kit

This file is the authoritative context for GitHub Copilot when developing generated applications in `/repos/`. All rules from the organization's standards are embedded here directly — no external file reads required.
...
```json
// public/static-config.json — NEVER hardcode clientId/authority in code
{
  "clientId": "",
